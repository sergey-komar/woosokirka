$(function() {
	...
	$('.sort-menu li').on('click',function() {
		...
		window.location =  'http://localhost/wordpress/shop/?orderby=' + $(this).find('a').data('value');
	});
...
$(document).ready(function(){
	...
	/*$('[data-submit]').on('click', function(e){
		e.preventDefault();
		$(this).parents('.subscribe__form, .cabinet__form, .review-form, .subscr__form, .callme-form').submit();
	})*/
	$.validator.addMethod(
		"regex",
	...
	function valEl(el){
		...
		el.validate({
			rules:{
				...
				phone:{ /*Проверка по данным атрибута name*/
					required:true,
					regex: '^([\+]+)*[0-9\x20\x28\x29\-]{11,20}$'
				},
				name:{
	...
	$('form.subscribe__form, .cabinet__form, .review-form, .subscr__form, .order-form, .callme-form,.wpcf7-form').each(function() {
		valEl($(this)); 
	});
});
